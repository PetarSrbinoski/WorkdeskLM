...
import {Sidebar} from '@/components/sidebar' // keep your left sidebar as-is
...
export default function HomePage() {
    ...
    const {sessionId, session, initializing, createNewSession} = useSession()
    ...
    const pushFlashcards = useCallback((cards: Flashcard[]) => {
        ...
        if (typeof window !== 'undefined') {
            console.log('FLASHCARDS MESSAGE', msg)
        }
